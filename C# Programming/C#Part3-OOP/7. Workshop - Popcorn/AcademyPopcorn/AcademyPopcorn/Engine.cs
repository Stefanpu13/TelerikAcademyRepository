...
namespace AcademyPopcorn
{
    public class Engine
    {
        ...
        //Task 2 : ...and Implement a constructor that takes it as additional parameter  
        public Engine(IRenderer renderer, IUserInterface userInterface, int sleepTime):
            this(renderer, userInterface) 
        {
            this.engineSleepTime = sleepTime;
        }
        ...
        private void AddRacket(GameObject obj)
        {
            ...
            //Task 3. Make sure that non of the objects in static objects is racket
            if (!this.staticObjects.Any(x =>x is Racket))
            {
            ...
            {
                throw new InvalidOperationException("Racket already added.");
            }
        }
